...
// projects
import L_CreativeAgency from "../../assets/img/projects/creative_agency.webp";
import L_VolunteerNetwork from "../../assets/img/projects/volunteer_network.webp";
import L_TravelGuru from "../../assets/img/projects/travel_guru.webp";
    ...
    <div id="projects">
      ...
      <Timeline>
        ...
        <ImageEvent
            ...
            text="Creative-Agency-Explore"
            src={L_CreativeAgency}
            alt="Creative Agency App"
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://creative-agency-explore.web.app/"
                  target="_blank"
                >
                  WATCH LIVE
                </UrlButton>
                ...
                <UrlButton
                  href="https://github.com/faizkhan01/creative-agency-client/"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
...
<ImageEvent
            date="16/09/2020"
            className="text-center"
            text="Volunteer-Network-Explore"
            src={L_VolunteerNetwork}
            alt="Volunteer Networking App"
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://volunteer-network-explore.web.app/"
                  target="_blank"
                >
                  WATCH LIVE
                </UrlButton>
                <UrlButton
                  href="https://github.com/faizkhan01/volunteer-network-explore-client"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://travel-guru-explore.web.app/"
                  target="_blank"
                >
                  WATCH LIVE
                </UrlButton>
                ...
                <UrlButton
                  href="https://github.com/faizkhan01/travel-guru-explore"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
